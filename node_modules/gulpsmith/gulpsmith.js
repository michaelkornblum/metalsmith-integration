(function() {
  ...
  (function() {
    ...
    _ref = Object.getOwnPropertyNames(File.prototype).concat(Object.getOwnPropertyNames(new File()));
    _results = [];
  ...
  gulpsmith.to_vinyl = function(relative, metal_file, smith) {
    ...
    opts.stat = null;
    if ((metal_file.stats != null) || (metal_file.mode != null)) {
      opts.stat = clone_stats((_ref = metal_file.stats) != null ? _ref : {});
      if (metal_file.mode != null) {
        opts.stat.mode = parseInt(metal_file.mode, 8);
      }
    }
